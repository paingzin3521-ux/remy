...
def main():
    while True:
        ...
        if c == '1':
            ...
            v = input(f"\n{C}HACK-TYPE > {W}")
            if v == '1': scanner_selector(string.digits, "DIGITS")
            elif v == '2': scanner_selector(string.ascii_lowercase, "LETTERS")
            elif v == '3': run_hack(string.ascii_lowercase + string.digits, 6, "MIXED")
        elif c == '0': sys.exit()
